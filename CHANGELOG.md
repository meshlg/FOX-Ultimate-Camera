...
- **Sprint Detection:** Fixed a Lua error ("function expected instead of nil") for clients where `IsUnitSprinting` is unavailable. Added a fallback to the previous key-based detection for stability.
